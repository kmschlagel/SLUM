...
<div id="content">
    ...
    <div id="main">
        ...
        <img src="images/VBS/funfair.png" width="185" height="242" style="float: right;">
        <h3>Vacation Bible School Registration</h3>

        <p>Invite your children, grandchildren, and friends to Everywhere Fun Fair this summer at Vacation Bible School! In our Vacation Bible School, Everywhere Fun Fair, kids from ages three through 6th Grade will experience the love of Jesus through Bible stories, games, fun crafts, music, discovery time, and dinner.<br><span class="bold">Monday August 12<sup>th</sup> - Thursday August 15<sup>th</sup></span><br><span class="bold">6:00pm - 8:00pm daily</span></p>
        <h3 style="color:#C9A68F; margin-top: 10px;">Registration Deadline: August 5th</h3>
